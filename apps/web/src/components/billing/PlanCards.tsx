  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2 xl:grid-cols-3">
      {PLANS.map((plan) => (
        <div
          key={plan.id}
          className={`relative flex min-h-full flex-col overflow-visible rounded-2xl border bg-gradient-glass p-4 sm:p-5 lg:p-6 ${plan.highlight ? 'border-brand-500/50 shadow-lg shadow-brand-600/20' : 'border-white/8'}`}
        >
          {plan.highlight && (
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-end gap-x-1 gap-y-0 pt-1 sm:pt-2">
              ...
              <span className="text-4xl font-black leading-none text-white sm:text-[2.65rem]">{plan.price}</span>
