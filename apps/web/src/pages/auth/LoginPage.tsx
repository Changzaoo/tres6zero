            ...
            >
              ...
              <div className="space-y-4 pt-1">
                <motion.label variants={formItem} className="block">
                  <span className="text-[11px] font-semibold text-white/70">Email</span>
                  <input
                    type="email"
                    autoComplete="email"
                ...
                <motion.label variants={formItem} className="block">
                  <span className="text-[11px] font-semibold text-white/70">Password</span>
              ...
              <motion.p variants={formItem} className="pt-5 text-center text-[10px] text-white/45">
                ...
                <Link to="/register" className="font-semibold text-brand-300 transition hover:text-brand-200 hover:underline">
                  Sign Up
                </Link>
              </motion.p>
            </motion.form>
