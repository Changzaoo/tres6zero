...
export const speedRampEffect: VideoEffectConfig = {
  ...
  longDescription: 'Varia a velocidade do video para aumentar impacto, com destaque no ponto principal do giro.',
  category: 'motion',
  intensity: 'high',
  recommendedFor: ['videos 360', 'festas', 'ativacoes de marca'],
  visualBehavior: [
    'Inicio em velocidade normal',
    'Aceleracao no meio',
